    ...
    <main className="min-h-screen bg-gray-100 px-4 py-10">
      <div className="mx-auto max-w-4xl">
        ...
        <section className="mb-8 rounded-xl border border-gray-200 bg-white p-6 shadow-sm">
          ...
          >
            ...
            <button
              type="submit"
              disabled={submitting}
              className="self-end rounded-lg bg-blue-600 px-5 py-2.5 text-sm font-medium text-white transition hover:bg-blue-700 disabled:cursor-not-allowed disabled:opacity-60 cursor-pointer"
            >
              <FontAwesomeIcon
                icon={faPlus}
                className="mr-2"
        ...
        <section>
          ...
          {loading && (
            <div className="rounded-xl border border-gray-200 bg-white p-8 text-center text-gray-700 shadow-sm">
              Loading tasks...
            </div>
          )}
  ...
  {new Date(task.created_at).toLocaleTimeString()}
                  ...
                  <div className="flex flex-col gap-3 sm:flex-row sm:items-end">
                    ...
                    <button
                      ...
                      className="rounded-lg border border-red-200 px-4 py-2 text-sm font-medium text-red-600 transition hover:bg-red-50 disabled:cursor-not-allowed disabled:opacity-60 cursor-pointer"
                    >
                      <FontAwesomeIcon
                        icon={faTrash}
                        className="mr-2"
          ...
          <div className="w-full max-w-sm rounded-xl bg-white p-6 shadow-lg">
            ...
            <div className="mt-6 flex justify-end gap-3">
              ...
              <button
                ...
                disabled={deletingTaskId === taskToDelete}
